...
router.post('/login', async (req, res) => {
    ...
    try {
        let dbUser = await global.mainDb.models.User.findOne({ username: reqUser.username });
...
router.post('/register', async (req, res) => {
    ...
    try {
        ...
        let newUser = new global.mainDb.models.User({ firstName, lastName, username: username, password: hashedPassword });
